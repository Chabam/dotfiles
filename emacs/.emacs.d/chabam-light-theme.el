...
(let (
      ...
      (chabam-blue            "#0095d6")
      (chabam-blue-bg         "#92bbfc")
      (chabam-light-blue      "#41b2e2")
      (chabam-turquoise       "#02cecb")
      (chabam-dark-turquoise  "#00a8a5")
      (chabam-purple          "#8742d6")
      (chabam-purple-bg       "#9e92fc")
      (chabam-light-blue-bg   "#ddeaff")
      (chabam-light-purple-bg "#d8bfff")
  ...
  (custom-theme-set-faces
   ...
   `(region                             ((t (:background ,chabam-light-blue-bg))))
   `(match                              ((t (:background ,chabam-purple-bg))))
   `(secondary-selection                ((t (:background ,chabam-light-purple-bg))))
